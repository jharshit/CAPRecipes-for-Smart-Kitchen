...
The [issue tracker](https://github.com/jachinte/caprecipes/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/caprecipes.git
   # Navigate to the newly cloned directory
   cd caprecipes
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/jachinte/caprecipes.git
   ```
